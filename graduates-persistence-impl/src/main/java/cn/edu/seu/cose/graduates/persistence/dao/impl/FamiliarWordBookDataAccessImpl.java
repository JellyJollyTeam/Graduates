 ...
 */
public class FamiliarWordBookDataAccessImpl
        extends AbstractDataAccess implements FamiliarWordBookDataAccess {
    
    public FamiliarWordBookDataAccessImpl(DataSource dataSource) {
        super(dataSource);
    }
